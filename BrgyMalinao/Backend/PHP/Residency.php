...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://localhost/BrgyMalinao/Backend/CSS/Residency.css">
    ...
    <body>
        ...
        <nav id="sidebar">
            ...
            <div class="First-container">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        <a href="Residency.php" class="nav-link active" id="residency">
        ...
        <script>
            document.getElementById("streetSelect").addEventListener("change", function() {
                    ...
                    xhr.open("POST", "SearchRes.php", true);
