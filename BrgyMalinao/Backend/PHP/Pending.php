...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://localhost/BrgyMalinao/Backend/CSS/Pending.css">
    ...
    <body>
        ...
        <main>
            ...
            <div class="First-container">
                ...
                <div class="col">
                    <div class="row">
                        <a href="Pending.php" class="nav-link active" id="pending">
                            <p>Pendings</p>
                        </a>
                    </div>
                    <div class="row">
                        <a href="PendingRejected.php" class="nav-link" id="rejected">
                            <p>Rejected</p>
                        </a>
                    </div>
                </div>
        ...
        <script src="http://localhost/BrgyMalinao/Backend/JS/Accepted.js"></script>
        <script src="http://localhost/BrgyMalinao/Backend/JS/HandleRejection.js"></script>
        ...
        <script>
            ...
            document.getElementById("searchInput").addEventListener("keypress", function(event) {
                if (event.key === "Enter") {
                    ...
                    xhr.open("POST", "PendingSearch.php", true);
                    xhr.send(formData);
                }
            });
