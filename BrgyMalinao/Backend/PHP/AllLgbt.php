    ...
    <body>
        ...
        <nav id="sidebar">
            ...
            <div class="First-container">
                ...
                <div class="col">
                    <div class="row">
                        <a href="AllMale.php" class="nav-link" id="resident-info">
                            <p>Male Residents</p>
                        </a>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <a href="AllLgbt.php" class="nav-link active" id="resident-info">
        ...
        <script>
            document.getElementById("streetSelect").addEventListener("change", function() {
                    ...
                    xhr.open("POST", "SearchL.php", true);
