...
$years_in_barangay = isset($_GET['years_in_barangay']) ? htmlspecialchars($_GET['years_in_barangay']) : '';
$address = isset($_GET['address']) ? htmlspecialchars($_GET['address']) : '';
$purpose = isset($_GET['purpose']) ? htmlspecialchars($_GET['purpose']) : '';
$dateissued = isset($_GET['dateIssued']) ? htmlspecialchars($_GET['dateIssued']) : '';
?>
...
<body>
    <div class="print-btn">
        ...
        <button style="padding: 10px;" onclick="window.location.href='Residency.php'">Cancel</button>
    </div>
    ...
    <div id="page-wrapper">
        <div style="position: relative;">
            ...
            <div class="certificate-title">
                <br><b>CERTIFICATE OF RESIDENCY</b><br><br>
            </div>

            <div class="content">
                <p>This is to certify that <b><?php echo $fullname; ?></b>, of legal age, a bona fide resident of BARANGAY MALINAO 
                    for <?php echo $years_in_barangay; ?> years with a residential address at <?php echo $address; ?>.</p>
                    <p>This certification is being issued upon the request of the above-mentioned name for the purpose of securing a clearance for <?php echo $purpose; ?>.</p>
