    ...
    <body>
        ...
        <nav id="sidebar">
            ...
            <div class="First-container">
                ...
                <div class="col">
                    <div class="row">
                        <a href="Pending.php" class="nav-link" id="pending">
                            <p>Pendings</p>
                        </a>
                    </div>
                    <div class="row">
                        <a href="PendingRejected.php" class="nav-link active" id="rejected">
                            <p>Rejected</p>
                        </a>
                    </div>
                </div>
        ...
        <script>
            document.getElementById("streetSelect").addEventListener("change", function() {
                    ...
                    xhr.open("POST", "RejectedSearch.php", true);
