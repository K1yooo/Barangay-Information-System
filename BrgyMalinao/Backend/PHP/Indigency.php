...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="http://localhost/BrgyMalinao/Backend/CSS/Indigency.css">
    ...
    <body>
        ...
        <nav id="sidebar">
            ...
            <div class="First-container">
                ...
                <div class="col">
                    ...
                    <div class="row">
                        <a href="Indigency.php" class="nav-link active" id="indigency">
                            <p>Certification of Indigency</p>
                        </a>
                    </div>
                    <div class="row">
                        <a href="Business.php" class="nav-link" id="business">
        ...
        <script>
            document.getElementById("streetSelect").addEventListener("change", function() {
                    ...
                    xhr.open("POST", "SearchInd.php", true);
