...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/BrgyMalinao/Backend/CSS/BarangayForms.css">
...
<body>
    ...
    <main>
        ...
        <div class="First-container">
            ...
            <div class="col">
                <div class="row">
                    <a href="BarangayForms.php" class="nav-link active" id="clearance">
    ...
    <script src="http://localhost/BrgyMalinao/Backend/JS/IncDec.js"></script>
        <script>
            document.getElementById("streetSelect").addEventListener("change", function() {
                    ...
                    xhr.open("POST", "SearchClear.php", true);
