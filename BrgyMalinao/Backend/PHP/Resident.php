    ...
    <body>
                ...
                <div class="search-container">
                    ...
                    <div>
                        <select id="streetSelect" class="styled-select">
                            ...
                            <?php
                                $stmt = $con->prepare("SELECT `Street_ID`, `streetHOA` FROM `street_name`");
                                $stmt->execute();
                    ...
                    <div class="Scrollable-table">
                        <table>
                            ...
                            <tbody id="searchResults">
                                <?php include 'ResidentSearch.php'; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
        ...
        window.location.href = "viewResident.php?id=" + residentId;
            ...
            document.getElementById("streetSelect").addEventListener("change", function() {
                ...
                xhr.open("POST", "ResidentSearch.php", true);
                xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                xhr.send("street=" + encodeURIComponent(selectedStreet));
            });
            ...
            function archiveResident(rs_id) {
                var confirmation = confirm("Are you sure you want to archive this resident?");
                if (confirmation) {
                    var xhr = new XMLHttpRequest();
                    xhr.onreadystatechange = function() {
                        if (xhr.readyState === XMLHttpRequest.DONE) {
                    ...
                    xhr.open("POST", "ResidentSearch.php", true);
                    xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xhr.send("archive=true&rs_id=" + encodeURIComponent(rs_id));
                }
            }
        </script>
    </body>
