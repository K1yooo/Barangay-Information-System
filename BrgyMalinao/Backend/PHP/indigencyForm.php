...
<body>
    ...
    <div id="page-wrapper">
        <div style="position: relative;">
            ...
            <div class="content">
                <p>This is to certify that <b><?php echo $requesterName; ?></b>, of legal age and 
                <?php 
                ...
                ?> 
                of this barangay presently residing at <?php echo $address; ?> and is one of the indigents in our barangay.</p>
                <p>This certification is being issued upon the request of the above-mentioned name for the purpose of securing an indigency for <?php echo $purpose; ?>.</p>
